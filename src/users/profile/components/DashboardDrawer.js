...
export const DashboardDrawer = ({ open, handleDrawerClose }) => (
  <DrawerStyled variant="permanent" open={open}>
    ...
    <Divider />
    {/* Render MainListItems as a component */}
    <List sx={{ background: '#5779A7', color: '#E5E7EA' }}>
      <MainListItems />
    </List>
    <Divider />
    {/* Assuming secondaryListItems is still exported as a JSX expression */}
    <List sx={{ background: '#747D8B', color: '#E5E7EA', height: '100%' }}>
      {secondaryListItems}
    </List>
  </DrawerStyled>
);
