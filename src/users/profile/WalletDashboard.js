...
<TextField autoFocus margin="dense" id="recipientAddress" label="Recipient Address"
type="text"
fullWidth
variant="outlined"
...
<Typography variant="body2">{nft.positionSummary}</Typography></Box>
<Typography variant="body2">Responsibilities:</Typography>
<Box sx={scrollableTextStyle}>
<Typography variant="body2">{nft.responsibilities}</Typography></Box>
<Typography variant="body2">Qualifications:</Typography>
<Box sx={scrollableTextStyle}>
<Typography variant="body2">{nft.qualifications}</Typography></Box>    
...
<Button variant="contained" color="primary" onClick={() => { setSelectedTokenId(nft.tokenId); setIsModalOpen(true);}} sx={{ color: '#000000', margin: '0px 10px 0 0', background: 'gold', fontWeight: '550', textAlign: 'center' }}>Send</Button>
